...
> Nesse ponto do texto, seria interessante deixar claro para o leitor de onde foram extraídas as informações de r7, r8..., além do que já é feito, de informar o significado de cada uma das variáveis. Também seria bacana explicar como realizar a leitura das informações para, por exemplo, perceber que 50% dos valores estão concentrados em determinadadas notas.
...
>> Texto muito bom e completo, descrevendo muito bem tudo o que está sendo feito e facilitando a compreensão para o leitor. Parabéns!